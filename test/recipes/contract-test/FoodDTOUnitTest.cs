...
namespace Mougnibas.LazyCook.Recipes.Contract.Test
{
    ...
    /// <summary>
    /// FoodDTO unit test class.
    /// </summary>
    [TestClass]
    public class FoodDTOUnitTest
    {
        /// <summary>
        /// The class instance to test.
        /// </summary>
        private FoodDTO toTest;
        ...
        /// <summary>
        /// Test <see cref="FoodDTO.Name"/> property.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Test <see cref="FoodDTO.Mass"/> property.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Test <see cref="FoodDTO.Equals(object)"/> method.
        /// </summary>
        [TestMethod]
        ...
        {
            string hack = "FoodDTO(Name='Tomato', Mass='500')";
            Assert.AreNotEqual(this.toTest, hack);
        }

        /// <summary>
        /// Test <see cref="FoodDTO.GetHashCode()"/> method.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Test <see cref="FoodDTO.ToString()"/> method.
        /// </summary>
        [TestMethod]
        public void TestToString()
        {
            string expected = "FoodDTO(Name='Tomato', Mass='500')";
